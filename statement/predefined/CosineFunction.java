...
public class CosineFunction extends EvaluateFunction {
	
	public CosineFunction(String functionName, List<Expression> parameterExpressions) throws ParseException {
