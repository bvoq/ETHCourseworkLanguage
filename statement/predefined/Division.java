...
public class Division extends EvaluateFunction {
	
	public Division(String functionName, List<Expression> parameterExpressions) throws ParseException {
		super(functionName, parameterExpressions);
		if(parameterExpressions.size() != 2) throw new ParseException( ParseException.createSyntaxErrorMessage("2 arguments at division", "", -1, ""));
	}
